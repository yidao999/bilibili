 ...
 */
@ActivityScope
public class TotalStationSearchModel extends BaseModel implements TotalStationSearchContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public TotalStationSearchModel(IRepositoryManager repositoryManager) {
