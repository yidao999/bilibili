...
import com.example.bilibilidemo.di.component.DaggerConsumeHistoryComponent;
import com.example.bilibilidemo.mvp.contract.ConsumeHistoryContract;
import com.example.bilibilidemo.mvp.presenter.ConsumeHistoryPresenter;
 ...
 * ================================================
 */
public class ConsumeHistoryFragment extends BaseFragment<ConsumeHistoryPresenter> implements ConsumeHistoryContract.View {
    ...
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerConsumeHistoryComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    public View initView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_consume_history, container, false);
    }
