 ...
 */
@FragmentScope
public class AttentionPeopleModel extends BaseModel implements AttentionPeopleContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public AttentionPeopleModel(IRepositoryManager repositoryManager) {
