 ...
 */
@FragmentScope
public class ConsumeHistoryModel extends BaseModel implements ConsumeHistoryContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public ConsumeHistoryModel(IRepositoryManager repositoryManager) {
