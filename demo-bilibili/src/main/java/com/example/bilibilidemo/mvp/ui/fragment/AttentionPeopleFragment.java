...
import com.example.bilibilidemo.di.component.DaggerAttentionPeopleComponent;
import com.example.bilibilidemo.mvp.contract.AttentionPeopleContract;
import com.example.bilibilidemo.mvp.presenter.AttentionPeoplePresenter;
 ...
 * ================================================
 */
public class AttentionPeopleFragment extends BaseFragment<AttentionPeoplePresenter> implements AttentionPeopleContract.View {
    ...
    public static AttentionPeopleFragment newInstance() {
        AttentionPeopleFragment fragment = new AttentionPeopleFragment();
        return fragment;
    }

    @Override
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerAttentionPeopleComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    public View initView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_attention_people, container, false);
    }
