 ...
 */
@ActivityScope
public class HotBitmapGGInfoModel extends BaseModel implements HotBitmapGGInfoContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public HotBitmapGGInfoModel(IRepositoryManager repositoryManager) {
