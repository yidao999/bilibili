...
import com.example.bilibilidemo.di.component.DaggerIFavoritesComponent;
import com.example.bilibilidemo.mvp.contract.IFavoritesContract;
import com.example.bilibilidemo.mvp.presenter.IFavoritesPresenter;
 ...
 * ================================================
 */
public class IFavoritesFragment extends BaseFragment<IFavoritesPresenter> implements IFavoritesContract.View {
    ...
    public static IFavoritesFragment newInstance() {
        IFavoritesFragment fragment = new IFavoritesFragment();
        return fragment;
    }

    @Override
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerIFavoritesComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    public View initView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_ifavorites, container, false);
    }
